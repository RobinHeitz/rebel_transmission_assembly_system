...
layout = [
    ...
    [sg.Text("Behebungsmaßnahmen", font=font_normal)],
    [sg.Listbox(values=[], select_mode=sg.LISTBOX_SELECT_MODE_MULTIPLE, k=Keys.LISTBOX_IMPROVEMENTS, expand_x=True, size=(None, 6), font=font_normal, enable_events=True)],
