...
Revision ID: 2fcd63a18356
Revises: 
Create Date: 2022-08-25 17:18:07.688420
...
def upgrade() -> None:
    ...
    sa.Column('failure_classification', sa.Enum('failure_type_overcurrent', 'failure_type_others', name='failureclassification'), nullable=True),
